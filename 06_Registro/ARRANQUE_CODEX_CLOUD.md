...
2. Ejecuta `python tools/oloverso_drive_workflow.py plan --limit 3`.
3. Lee los prompts repo-relativos devueltos por el plan.
4. Procesa las imagenes de una en una: generar temporal, validar visualmente, subir a Drive, registrar y commitear metadatos.
...
- Que el siguiente lote viene de `tools/oloverso_drive_workflow.py plan --limit 3`.
